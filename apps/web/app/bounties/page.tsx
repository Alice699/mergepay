    ...
    <main className="page-main page-width">
      ...
      <div className="content-grid">
        ...
        <aside className="panel readiness-panel">
          ...
          <p className="panel-note">Discovery is live from Rialo account data. Automatic merged-PR payout and deadline refund are proven on the active DevNet program.</p>
        </aside>
      </div>
    </main>
  );
